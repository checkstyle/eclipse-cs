...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <script type="text/javascript"> YAHOO.util.Event.onContentReady("content", setupZoom);
                </script>
                                    ...
                                    <div id="googleads">
                                        <script type="text/javascript">
                                            <xsl:comment>
                                                ...
                                                google_ad_slot = "6310931050"; google_ad_width = 728; google_ad_height =
                                                90;
                                                //
                                            </xsl:comment>
                                        </script>
                    ...
                    <div class="bd">
                        <ul>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.6.1/release_notes.html">
                                    Release Notes</a>
                                <div id="releasnotes" class="yuimenu">
                                    <div class="bd">
                                        <ul class="first-of-type">
                                            ...
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.6.0/release_notes.html">
                                                    Release 5.6.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.5.0/release_notes.html">
                                                    Release 5.5.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.4.1/release_notes.html">
                                                    Release 5.4.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.4.0/release_notes.html">
                                                    Release 5.4.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.3.0/release_notes.html">
                                                    Release 5.3.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.2.0/release_notes.html">
                                                    Release 5.2.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.1.1/release_notes.html">
                                                    Release 5.1.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.1.0/release_notes.html">
                                                    Release 5.1.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.0.3/release_notes.html">
                                                    Release 5.0.3</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.0.2/release_notes.html">
                                                    Release 5.0.2</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.0.1/release_notes.html">
                                                    Release 5.0.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/5.0.0final/release_notes.html">
                                            ...
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.4.2/release_notes.html">
                                                    Release 4.4.2</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.4.1/release_notes.html">
                                                    Release 4.4.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.4.0/release_notes.html">
                                                    Release 4.4.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.3.3/release_notes.html">
                                                    Release 4.3.3</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.3.2/release_notes.html">
                                                    Release 4.3.2</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.3.1/release_notes.html">
                                                    Release 4.3.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.3.0/release_notes.html">
                                                    Release 4.3.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.2.1/release_notes.html">
                                                    Release 4.2.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/4.2.0/release_notes.html">
                                                    Release 4.2.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="{$path-prefix}releasenotes/release_notes_older.html">
                                                    Older releases</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div id="gethelp" class="yuimenu">
                                    <div class="bd">
                                        <ul class="first-of-type">
                                            ...
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel" href="https://sourceforge.net/forum/?group_id=80344">
                ...
                <div id="download" class="yuimenu">
                    <div class="bd">
                        <ul>
                            ...
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="https://sourceforge.net/project/showfiles.php?group_id=80344">
            ...
            <li class="yuimenubaritem">
                ...
                <div id="basicdocs" class="yuimenu">
                    <div class="bd">
                        <ul>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}basic_setup_project.html">Setting up a
                                    project
                                </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}basic_creating_config.html">Creating a check
                                    configuration
                                </a>
                            </li>
                        </ul>
            ...
            <li class="yuimenubaritem">
                ...
                <div id="advanceddocs" class="yuimenu">
                    <div class="bd">
                        <ul>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_file_sets.html">Using filesets </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_filters.html">Plugin filters </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_configtypes.html">Configuration
                                    types
                                </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_team.html">Team support</a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_regularexpressions.html">Using
                                    regular expressions
                                </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_properties.html">Expanding property
                                    placeholders
                                </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_preferences.html">Advanced
                                    Preferences
                                </a>
                            </li>
            ...
            <li class="yuimenubaritem">
                ...
                <div id="project" class="yuimenu">
                    <div class="bd">
                        <ul>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}developers.html">Project members</a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="http://sourceforge.net/projects/eclipse-cs/"> SourceForge
                                    project page
                                </a>
                            </li>
                        </ul>
        ...
        <div id="header">
            <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td
                        ...
                        <xsl:if test="$style = 'website'">
                            <form action="http://www.google.com/cse" id="cse-search-box" target="_blank">
                                <div>
                                    <input type="hidden" name="cx" value="partner-pub-9204862326418919:fottii-3k6j" />
                    ...
                    <td>
                        <a class="FlattrButton" style="display:none;" href="http://eclipse-cs.sourceforge.net/"></a>
                    </td>
                    <td style="vertical-align: middle; width: 155px; height: 75px; padding-right: 5px;">
                        <a href="http://sourceforge.net/projects/eclipse-cs">
                            <img src="http://sflogo.sourceforge.net/sflogo.php?group_id=80344&amp;type=14" width="150"
                                height="40"
                                alt="Get Eclipse Checkstyle Plug-in at SourceForge.net. Fast, secure and Free Open Source software downloads" />
                        </a>
                        <script type="text/javascript" src="http://www.ohloh.net/p/6568/widgets/project_thin_badge.js">
                            <xsl:comment />
                        </script>
                    </td>
                </tr>
    ...
    <xsl:template name="footer">
        <div id="footer">
            Copyright &#xA9; 2002-2012 David Schneider,
