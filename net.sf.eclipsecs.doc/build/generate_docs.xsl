                        ...
                        <ul>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel"
                                    href="{$path-prefix}releasenotes/5.4.1/release_notes.html"
                                    >Release Notes</a>
                                <div id="releasnotes" class="yuimenu">
                                    <div class="bd">
                                        <ul class="first-of-type">
                                            ...
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel"
                                                    href="{$path-prefix}releasenotes/5.4.0/release_notes.html"
                                                    > Release 5.4.0</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel"
                                            ...
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel"
                                                    href="{$path-prefix}releasenotes/5.1.1/release_notes.html"
                                                    > Release 5.1.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel"
                                            ...
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel"
                                                    href="{$path-prefix}releasenotes/5.0.2/release_notes.html"
                                                    > Release 5.0.2</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel"
                                                    href="{$path-prefix}releasenotes/5.0.1/release_notes.html"
                                                    > Release 5.0.1</a>
                                            </li>
                                            <li class="yuimenuitem">
                                                <a class="yuimenuitemlabel"
