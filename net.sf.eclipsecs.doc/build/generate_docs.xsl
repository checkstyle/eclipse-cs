...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:template name="navigation">
        <ul class="first-of-type">
                ...
                <div id="main" class="yuimenu">
                    <div class="bd">
                        <ul>
                            ...
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}screen_shots.html"> Screenshots </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}rad_usage.html"> RAD 6/7 issues</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <li class="yuimenubaritem">
                <a class="yuimenubaritemlabel" href="{$path-prefix}downloads.html">Download &amp; Installation</a>
            ...
            <li class="yuimenubaritem">
                <a class="yuimenubaritemlabel" href="{$path-prefix}getting_started.html">Getting Started</a>
                <div id="basicdocs" class="yuimenu">
                    <div class="bd">
                        <ul>
                            ...
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}basic_creating_config.html">Creating a
            ...
            <li class="yuimenubaritem">
                ...
                <div id="advanceddocs" class="yuimenu">
                    <div class="bd">
                        <ul>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_file_sets.html">Using filesets
                                </a>
                            </li>
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_filters.html">Plugin filters
                                </a>
                            </li>
                            <li class="yuimenuitem">
                            ...
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}advanced_properties.html">Expanding
                            ...
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="{$path-prefix}maven.html">Synchronizing with
                                    m2eclipse</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div id="project" class="yuimenu">
                    <div class="bd">
                        <ul>
                            ...
                            <li class="yuimenuitem">
                                <a class="yuimenuitemlabel" href="http://sourceforge.net/projects/eclipse-cs/">
    ...
    <xsl:template name="footer">
        <div id="footer"> Copyright &#xA9; 2002-2009 David Schneider, <a href="http://www.koedderitzsch.net">Lars
                Ködderitzsch</a>. All Rights Reserved. </div>
    </xsl:template>
</xsl:stylesheet>
