	...
	<xsl:template name="navigation">
		<div class="buttons">
			...
			<xsl:if test="$section != 'docs-basic'">
				<a href="{$path-prefix}getting_started.html" class="level1"><img src="{$path-prefix}images/plus.gif" alt=""
					/>Getting Started</a>
			</xsl:if>
			<xsl:if test="$section = 'docs-basic'">
				<a href="{$path-prefix}getting_started.html" class="level1"><img src="{$path-prefix}images/minus.gif" alt=""
					/>Getting Started</a>
			...
			<xsl:if test="$section != 'docs-adv'">
				<a href="{$path-prefix}advanced_file_sets.html" class="level1"><img src="{$path-prefix}images/plus.gif" alt=""
					/>Advanced topics</a>
			</xsl:if>
			<xsl:if test="$section = 'docs-adv'">
				<a href="{$path-prefix}advanced_file_sets.html" class="level1"><img src="{$path-prefix}images/minus.gif" alt=""
					/>Advanced topics</a>
			...
			<xsl:if test="$section != 'docs-ext'">
				<a href="{$path-prefix}extending_custom_checks.html" class="level1"><img src="{$path-prefix}images/plus.gif"
						alt=""/>Extending the Checkstyle Plug-in</a>
			</xsl:if>
			<xsl:if test="$section = 'docs-ext'">
				<a href="{$path-prefix}extending_custom_checks.html" class="level1"><img src="{$path-prefix}images/minus.gif"
						alt=""/>Extending the Checkstyle Plug-in</a>
			...
			<xsl:if test="$section = 'project'">
				<a href="{$path-prefix}news.shtml" class="level1"><img src="{$path-prefix}images/minus.gif" alt=""/>eclipse-cs
					project</a>
