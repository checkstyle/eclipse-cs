 ...
 */
public class RuleGroupMetadataFactory implements XMLTags
{
    //=================================================
     ...
     */
    private RuleGroupMetadataFactory()
    {}
	...
	private static void doInitialization()
	{
		...
		try
		{
			...
			//
			metadataStream = 
                RuleGroupMetadataFactory.class.getResourceAsStream(METADATA_FILENAME);
