...
/**
 * Abstract class which all transformationclasses have to implement. These
 * classes handle how to react on a checkstyle-rule.
 * 
 * @author Lukas Frena
 */
public abstract class CTransformationClass {
    ...
    /**
     * Method for transforming the checkstyle-rule this class is associated to.
     * Every transformationclass has to implement this method. Should return the
     * field formatterSetting after adding rules to it.
     * 
    ...
    /**
     * Method for defining which eclipse-formatter-rules should be used for
     * transforming.
     * 
     * @param rule
    ...
    /**
     * Method for defining which eclipse-editor-rules should be used for
     * transforming.
     * 
     * @param rule
