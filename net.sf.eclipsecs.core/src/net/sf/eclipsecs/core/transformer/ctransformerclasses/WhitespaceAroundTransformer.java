...
/**
 * Wrapperclass for converting the checkstyle-rule WhitespaceAround to appropriate eclipse-formatter-rules.
 *
 * @author Lukas Frena
 */
    ...
    public FormatterConfiguration transformRule() {
        ...
        while (token.hasMoreTokens()) {
            ...
            if (tok.equals("ASSIGN") || tok.equals("BAND_ASSIGN") || tok.equals("BOR_ASSIGN")
                ...
                || tok.equals("MINUS") || tok.equals("MOD") || tok.equals("NOT_EQUAL") || tok.equals("PLUS")
