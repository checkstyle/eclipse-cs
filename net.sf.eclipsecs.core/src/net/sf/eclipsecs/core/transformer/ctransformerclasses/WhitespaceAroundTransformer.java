...
/**
 * Wrapperclass for converting the checkstyle-rule WhitespaceAround to
...
public class WhitespaceAroundTransformer extends CTransformationClass {
    ...
    public FormatterConfiguration transformRule() {
        ...
        while (token.hasMoreTokens()) {
            tok = token.nextToken();
            if (tok.equals("ASSIGN") || tok.equals("BAND_ASSIGN")
                || tok.equals("BOR_ASSIGN") || tok.equals("BSR_ASSIGN")
                || tok.equals("BXOR_ASSIGN") || tok.equals("DIV_ASSIGN")
                ...
                || tok.equals("BSR") || tok.equals("BXOR") || tok.equals("DIV")
                || tok.equals("EQUAL") || tok.equals("GE") || tok.equals("GT")
                || tok.equals("LAND") || tok.equals("LE") || tok.equals("LOR")
