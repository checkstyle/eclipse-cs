    ...
    public FormatterConfiguration transformRule() {
        ...
        for (String token : val.split("\\s*,\\s*")) {
            List<String> settings = switch (token) {
                ...
                case "SEMI" -> List.of("insert_space_before_semicolon",
                ...
                case "LABELED_STAT" -> List.of("insert_space_before_colon_in_labeled_statement");
                case "GENERIC_START" -> List.of(
