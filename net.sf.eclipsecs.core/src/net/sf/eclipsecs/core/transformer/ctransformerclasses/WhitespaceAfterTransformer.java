...
/**
 * Wrapperclass for converting the checkstyle-rule WhitespaceAfter to
...
public class WhitespaceAfterTransformer extends CTransformationClass {
    ...
    public FormatterConfiguration transformRule() {
        ...
        while (token.hasMoreTokens()) {
            tok = token.nextToken();
            if (tok.equals("COMMA")) {
                userFormatterSetting("insert_space_after_comma_in_annotation",
                    "insert");
                ...
                userFormatterSetting(
                    ...
                    "insert");
                userFormatterSetting("insert_space_after_comma_in_for_inits",
                    "insert");
                userFormatterSetting(
