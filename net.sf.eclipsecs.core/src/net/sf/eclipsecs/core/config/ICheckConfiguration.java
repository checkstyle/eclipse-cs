...
public interface ICheckConfiguration {
    ...
    /**
     * Returns if the check configuration is a global configuration, configured for the workspace,
     * or a local configuration for a single project.
     *
     ...
     * check configuration. Clients should not try to open an actual stream to the configuration
     * file, since this is not guaranteed to work.
     *
