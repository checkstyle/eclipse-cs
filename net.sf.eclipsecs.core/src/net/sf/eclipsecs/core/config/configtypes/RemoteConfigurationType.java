    ...
    public CheckstyleConfigurationFile getCheckstyleConfiguration(
        ...
        try {
            ...
            try {
                ...
                final RemoteConfigAuthenticator auth =
                    RemoteConfigAuthenticator.create(data.getResolvedConfigFileURL());
                if (auth != null) {
            ...
            CheckstylePluginException.rethrow(exception, NLS
                .bind(Messages.RemoteConfigurationType_errorUnknownHost, exception.getMessage()));
        }
        catch (FileNotFoundException exception) {
            CheckstylePluginException.rethrow(exception, NLS
                .bind(Messages.RemoteConfigurationType_errorFileNotFound, exception.getMessage()));
        }
        ...
        public static RemoteConfigAuthenticator create(URL resolvedCheckConfigurationUrl) {
            ...
            try {
                ...
                if (userName != null && password != null) {
                    ...
                    final String basicAuthHeaderValue =
                        "Basic " + Base64.getEncoder().encodeToString(unencodedHeader.getBytes());
