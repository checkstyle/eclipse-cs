...
public interface IConfigurationType {
     ...
     */
    void initialize(String name, String internalName, String definingPluginId, boolean isCreatable, boolean isEditable,
     ...
     *
     * @return <code>true</code> if the check configuration type is creatable, otherwise <code>false</code>
     */
    boolean isCreatable();
    ...
    /**
     * Determines if the checkstyle configuration associates with this check configuration can be configured.
     *
     ...
     */
    void notifyCheckConfigRemoved(ICheckConfiguration checkConfiguration) throws CheckstylePluginException;

    /**
     * Returns the resolved location URL of the Checkstyle configuration file configured for the given check
     * configuration. Clients should not try to open an actual stream to the configuration file, since this might not
     * work directly.
     *
     * @param checkConfiguration
     ...
     */
    URL getResolvedConfigurationFileURL(ICheckConfiguration checkConfiguration) throws CheckstylePluginException;

    /**
     * Get all data of the Checkstyle configuration (file data, additional properties...) in one go. This is done to
     * optimize the number of accesses that must be done on the configuration files.
     *
     * @param checkConfiguration
