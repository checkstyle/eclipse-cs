...
public interface IConfigurationType {
    ...
    /**
     * Returns the resolved location URL of the Checkstyle configuration file configured for the
     * given check configuration. Clients should not try to open an actual stream to the
     * configuration file, since this might not work directly.
     *
     * @param checkConfiguration
