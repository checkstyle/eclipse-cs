...
public final class ConfigurationReader {
    ...
    public static List<Module> read(InputSource input) throws CheckstylePluginException {
        ...
        try {
            ...
            reader
                .setEntityResolver(new XMLUtil.InternalDtdEntityResolver(PUBLIC2INTERNAL_DTD_MAP));
    ...
    private static void addProperties(final Element moduleEl, final Module module) {
        ...
        for (final Element propertyEl : propertyEls) {
            ...
            final boolean isPropertyRef =
                value != null && PROPERTY_REF_PATTERN.matcher(value).matches();
