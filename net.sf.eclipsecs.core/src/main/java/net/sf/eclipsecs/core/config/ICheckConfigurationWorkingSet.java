...
public interface ICheckConfigurationWorkingSet {
    ...
    /**
     * Creates a new working copy for an existing check configuration. The working copy is
     * associated with this working set albeit the new working copy is not added to the working sets
     * list of workin copies.
     *
     * @param checkConfig
    ...
    /**
     * Creates a new working copy with a given configuration type. The working copy is associated
