...
public interface IConfigPropertyWidget {
     ...
     *
     * @param enabled
     *            <code>true</code> if the widget should be enabled, <code>false</code> otherwise
     */
    ...
    /**
     * Validates the widgets data. A CheckstylePluginException with an appropriate message is thrown
