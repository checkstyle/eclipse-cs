//============================================================================
//
// Copyright (C) 2002-2012  David Schneider, Lars Ködderitzsch, Fabrice Bellingard
//
...
/**
 * <p>
 * Lightweight object that associates two files that have code in commons, and that tells where the duplicated code can
 * be found.
 * </p>
 * <p>
...
public class DuplicatedCode {
     ...
     * 
     * @return Returns the number of duplicated lines. Or zero if there were problems extracting this info from the
     *         Checkstyle message.
     */
     ...
     * 
     * @return the target file. Or NULL if there was a problem finding the resource.
     */
