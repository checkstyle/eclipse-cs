...
public class CheckConfigurationPropertiesDialog extends TitleAreaDialog {
     ...
     *            the parent shell
     * @param checkConfig
     *            the check configuration or <code>null</code> if a new check config should be
     *            created
     * @param workingSet
    ...
    private void initialize() {
        ...
        if (mCheckConfig == null) {
            ...
            if (mTemplate != null) {
                ...
                this.setTitle(
                    NLS.bind(Messages.CheckConfigurationPropertiesDialog_titleCopyConfiguration,
                        mTemplate.getName()));
     ...
     *            the name proposal
     */
    private static void setUniqueName(CheckConfigurationWorkingCopy config,
